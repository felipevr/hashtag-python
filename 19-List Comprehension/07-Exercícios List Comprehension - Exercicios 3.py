...
estoque = [('BSA2199',396),('PPF5239',251),('BSA1212',989),('PPF2154',449),('BEB3410',241),
...
pedido = [1000 if valor < 200 else 500 for produto,valor in estoque]
...
produtos_em_baixa = [produto for produto,valor in estoque if valor < 200]
print(produtos_em_baixa)